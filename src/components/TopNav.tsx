      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative" ref={profileRef}>
          <button
            ...
            className="flex items-center gap-3 pl-3 ml-1 border-l border-slate-200 dark:border-slate-700/50 hover:bg-slate-50 dark:hover:bg-slate-800/50 rounded-xl pr-2 py-1.5 transition-all"
          >
          ...
          {showProfile && (
            <div className="absolute right-0 mt-3 w-72 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border border-slate-200 dark:border-slate-700/50 rounded-2xl shadow-2xl shadow-slate-200/50 dark:shadow-slate-900/50 z-50 overflow-hidden">
              <div className="p-5 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border-b border-slate-100 dark:border-slate-800">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-600 to-purple-600 flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-indigo-500/30">
                    {user?.name?.charAt(0) || 'A'}
                  </div>
                  <div>
                    <p className="font-semibold text-slate-900 dark:text-white">{user?.name || 'Admin User'}</p>
                    <p className="text-sm text-slate-500 dark:text-slate-400">{user?.email || 'admin@dementiamithura.com'}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-2">
                <button
                  ...
                  className="flex items-center gap-3 w-full px-4 py-2.5 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-xl transition-colors"
                >
                  <User size={16} />
                  My Profile
                </button>
              ...
              <div className="p-2 border-t border-slate-100 dark:border-slate-800">
                <button
                  ...
                  className="flex items-center gap-3 w-full px-4 py-2.5 text-sm text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-900/20 rounded-xl transition-colors"
                >
                  <LogOut size={16} />
                  Logout
                </button>
